export default function Head() {
    return (
        <>
            <title>Member Count Chart</title>
            <meta name="theme-color" content="#67727a" key="theme-color" />
            <meta property="og:site_name" content="Member Traffic Chart" key="site-name" />
